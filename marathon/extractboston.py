...
def extract_to_CSV(collections, column_names):
    ...
    for collection_name in collections:
        ...
        for document in collection.find():
            document_runners = get_runners_data(document['content'])
        ...
        filename = 'data/'+collection_name+'_marathon.csv'
